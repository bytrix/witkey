...
$(document).ready(function(){
	// $("#myNav").affix();
	$('img').lazyload({
		placeholder: "{{ URL::asset('/assets/image/loading.gif') }}"
	});
});
</script>
@stop
...
@section('menu')
	...
	<li class="active"><a href="/help">{{Lang::get('message.help')}}</a></li>
...
@section('content')
	...
	<div class="container content">
		...
		<section>
			...
			<p>
				校园威客是一个致力于鼓励学生利用课余时间将知识与技能转化为经济收益的在线平台，在校园威客您可以帮同学买早饭；学习太忙，没时间打游戏？来校园威客找专业的游戏玩家为您打怪升级；电脑出故障了？来校园威客找IT大神；临近期末，苦于找不到各种复习资料？来校园威客找超级学霸！在这里，每一个人都可以成为服务提供者或服务享受者，还能赚外快哦！
			</p>
		</section>
